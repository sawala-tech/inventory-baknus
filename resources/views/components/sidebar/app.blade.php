    ...
    <nav class="sidebar card border-0 py-2 mb-4">
        <ul class="nav flex-column" id="nav_accordion">
            ...
            <li class="nav-item rounded {{ $currentPath == 'barang' ? 'bg-gray' : '' }}">
                <a class="nav-link item d-flex justify-content-between align-items-center {{ $currentPath == 'barang' ? 'text-body' : 'text-secondary' }}"
                    href="/barang">
                    <div>
            ...
            <li class="nav-item rounded {{ $currentPath == 'laporan' ? 'bg-gray' : '' }}">
                <a class="nav-link item d-flex justify-content-between align-items-center {{ $currentPath == 'laporan' ? 'text-body' : 'text-secondary' }}"
                    href="/barang/laporan">
                    <div>
